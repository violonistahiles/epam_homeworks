...
def save_parameters(first_func: Callable) -> Callable:
    def wrapper(second_func: Callable) -> Callable:
        """Function-wrapper which save parameters of original function"""
        def _wrapper(*args, **kwargs) -> Any:
            """Function-wrapper with perform another wrapper function"""
            return second_func(*args, **kwargs)
        _wrapper.__name__ = first_func.__name__
        _wrapper.__doc__ = first_func.__doc__
        _wrapper.__original_func = first_func
        return _wrapper
...
if __name__ == "__main__":
    ...
    print('Doc', custom_sum.__doc__)
    print('Name', custom_sum.__name__)
    print('Func', custom_sum.__original_func)
